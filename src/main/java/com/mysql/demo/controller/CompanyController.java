...
import com.mysql.demo.repository.CompanyRepository;
...
public class CompanyController {
    ...
    public List<Company> getAllCompanies() {
        ...
        for (int i = 0; i < companies.size(); i++) {
            ...
            company.setDatabaseUsername(System.getenv("username"));
            company.setDatabasePassword(System.getenv("password"));
